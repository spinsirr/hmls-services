...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_NOTIFICATIONSERVICE']._serialized_start=764
  _globals['_NOTIFICATIONSERVICE']._serialized_end=961
